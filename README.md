...
All credit goes to (@KeVanAlthius)[https://github.com/KeVanAlthius] for making this mod.

**Instructions:**

1. Save the Assembly-CSharp.dll gamefile
2. right click on the "Welcome To The Game 2" on steam.
3. Select Properties and go to "Open Game Files"
4. In the `WTTG2_Data` then `Managed` folder there should be an already existing "Assembly-CSharp.dll".
